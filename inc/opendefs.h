...
\author Mina Rady<mina1.rady@orange.com, 2020>
*/
...
//This is added by mm to compile directly a mote like a dagroot
//#define DAGROOT TRUE
...
enum {
   ...
   WKP_UDP_MONITOR                     =       3,
   WKP_UDP_INJECT                      =  61617,// 0xf0b1 //61617
...
enum {
   ...
   //added by mm
   COMPONENT_CMONITOR                  = 0x2b,
   COMPONENT_CINSTRUMENT               = 0x2c,
};
...
enum {
   ...
   ERR_6PTIMEOUT                       = 0x54, // 6add request timeout(code location {0})  
...
typedef struct {
   ...
   bool          l2_isHardCell;                                 //is the cell to be negociated Hard cell?
   //layer-2 security
