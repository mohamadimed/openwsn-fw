...
#define MAXKAPERIOD               1500*2  // in slots: 1500@20ms per slot -> ~30 seconds. Max value used by adaptive synchronization (500 for 1630 msslotframe).
#define DESYNCTIMEOUT             1750*4  // in slots: 1750@20ms per slot -> ~35 seconds. A larger DESYNCTIMEOUT is needed if using a larger KATIMEOUT.
