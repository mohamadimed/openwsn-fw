...
void board_init_slot_vars(void){
    ...
    slot_board_vars [SLOT_20ms_24GHZ].maxTxDataPrepare               =  30   ;  // 457us (based on measurement)
    slot_board_vars [SLOT_20ms_24GHZ].maxRxAckPrepare                =  20   ; // 305us (based on measurement)
    slot_board_vars [SLOT_20ms_24GHZ].maxRxDataPrepare               =  20   ; // 305us (based on measurement)
    slot_board_vars [SLOT_20ms_24GHZ].maxTxAckPrepare                =  30   ; // 457us (based on measurement)
    slot_board_vars [SLOT_20ms_24GHZ].delayTx                        =  13   ; // 183us (based on measurement)
    ...
    //40ms slot for FSK
    slot_board_vars [SLOT_40ms_FSK_SUBGHZ].slotDuration              =   328*4   ;  // tics  
    ...
    slot_board_vars [SLOT_40ms_FSK_SUBGHZ].maxTxAckPrepare           =   50   ;  // 1525µs  (based on measurement)
    ...
    slot_board_vars [SLOT_40ms_OFDM1MCS0_3_SUBGHZ].slotDuration      =  328*1   ;  // tics  
